...
type Game struct {
	...
	TurnTimeout  int32  `protobuf:"varint,7,opt,name=TurnTimeout,proto3" json:"TurnTimeout,omitempty"`
...
func (m *Game) GetTurnTimeout() int32 {
	if m != nil {
...
func NewPopulatedGame(r randyController, easy bool) *Game {
	...
	this.TurnTimeout = int32(r.Int31())
	if r.Intn(2) == 0 {
		this.TurnTimeout *= -1
	}
...
var fileDescriptorController = []byte{
	...
	,
}
