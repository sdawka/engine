...
type CreateRequest struct {
	...
	UseFoodSpawnPercentage bool            `protobuf:"varint,5,opt,name=UseFoodSpawnPercentage,proto3" json:"UseFoodSpawnPercentage,omitempty"`
	FoodSpawnChance        int32           `protobuf:"varint,6,opt,name=FoodSpawnChance,proto3" json:"FoodSpawnChance,omitempty"`
}
...
func (m *CreateRequest) GetUseFoodSpawnPercentage() bool {
	if m != nil {
		return m.UseFoodSpawnPercentage
	}
	return false
}

func (m *CreateRequest) GetFoodSpawnChance() int32 {
	if m != nil {
		return m.FoodSpawnChance
	}
	return 0
}
...
type Game struct {
	...
	UseFoodSpawnPercentage bool   `protobuf:"varint,9,opt,name=UseFoodSpawnPercentage,proto3" json:"UseFoodSpawnPercentage,omitempty"`
	FoodSpawnChance        int32  `protobuf:"varint,10,opt,name=FoodSpawnChance,proto3" json:"FoodSpawnChance,omitempty"`
}
...
func (m *Game) GetUseFoodSpawnPercentage() bool {
	if m != nil {
		return m.UseFoodSpawnPercentage
	}
	return false
...
func (m *Game) GetFoodSpawnChance() int32 {
	if m != nil {
		return m.FoodSpawnChance
	}
	return 0
...
func (this *CreateRequest) Equal(that interface{}) bool {
	...
	if this.UseFoodSpawnPercentage != that1.UseFoodSpawnPercentage {
		return false
	}
	if this.FoodSpawnChance != that1.FoodSpawnChance {
		return false
	}
	return true
}
...
func NewPopulatedCreateRequest(r randyController, easy bool) *CreateRequest {
	...
	this.UseFoodSpawnPercentage = bool(bool(r.Intn(2) == 0))
	this.FoodSpawnChance = int32(r.Int31())
	if r.Intn(2) == 0 {
...
var fileDescriptorController = []byte{
	...
	,
}
